...
<div class="statut-seance-container">
    ...
    <a href="{{ route('admin.statuts-seance.create') }}" class="btn-ajouter">+ Ajouter un statut</a>
    {{-- tableau --}}
                ...
                @foreach($statuts as $statut)
                    <tr>
                        ...
                        <td class="table-actions">
                            <a href="{{ route('admin.statuts-seance.edit', $statut) }}" class="btn-edit" title="Modifier">
                                <i class="bi bi-pencil-square"></i>
                            </a>
                            <form action="{{ route('admin.statuts-seance.destroy', $statut) }}" method="POST" onsubmit="return confirm('Supprimer ce statut ?')" style="display:inline;">
                                @csrf
                                @method('DELETE')
